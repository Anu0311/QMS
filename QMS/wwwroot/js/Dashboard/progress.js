...
var DashboardProgress = function() {
    ...
    return {
        init: function() {
            _ProgressRoundedChart('#hours-available-progress', 38, 2, '#2ec7c9', 456, 'icon-watch text-sky-100', 'CPR (In Progress)', '');
            _ProgressRoundedChart('#goal-progress', 38, 2, '#b6a2de', 974, 'icon-trophy3 text-puple-100', 'CPR Completed (Submit)', '');
        }
    }
}();
